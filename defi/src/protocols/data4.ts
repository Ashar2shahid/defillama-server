...
const data4: Protocol[] = [
  ...
  },
  {
    ...
    description: `Solido is building critical DeFi infrastructure on Move that lays the foundation for Supra's on-chain finance. The platform features three core DeFi primitives—Cash (Stablecoin), Flow (Liquid Staking), and Yield (Automated Strategies)—all designed to enhance the on-chain liquidity and capital efficiency on the Supra blockchain`,
    chain: "Supra",
